...
const Finance = ({ active }) => {
  ...
  const toDetail = id => {
    router.push(`/mx-defi/record-detail/${id}`);
  };
      ...
      <div className={styles.item} key={item.logId}>
        ...
        <div className={styles.itemRow}>
          ...
          <div>
            ...
            <p>{item.unlockTime ? moment(item.unlockTime).format('YYYY-MM-DD HH:mm:ss') : '--'}</p>
          </div>
          <div>
        ...
        <div className={styles.itemRow}>
          <div>
            <b
              onClick={() => {
                Modal.alert(formatMessage({ id: 'fin.title.progress' }), formatMessage({ id: 'mc_pos_count_progress' }));
              }}
            >
        ...
        <div className={cs(styles.itemRow, styles.btns)}>
          <span onClick={() => toDetail(item.logId)} className={cs(styles.Button, styles.blue)}>
          ...
          <span
            onClick={() => {
              ...
              alert(formatMessage({ id: 'ucenter.api.info.reminder' }), formatMessage({ id: 'pos.title.unlock_tip' }), [

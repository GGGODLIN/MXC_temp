...
import { newmarginBorrowList } from '@/services/api';
...
function LoanRecord({ active }) {
  ...
  const getOrderList = useCallback(
    (params = currentParams, type) => {
      newmarginBorrowList(params).then(result => {
  ...
  return (
    <ListView
      ...
      renderRow={item => <CommonRecord item={item} type="loan" />}

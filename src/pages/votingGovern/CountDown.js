...
class CountDown extends Component {
  ...
  render() {
    ...
    if (currentPhase.isOnSchedual) {
      countDownText = formatMessage({ id: 'votingNew.countDown.start' });
    }

    if (currentPhase.isVoting) {
      countDownText = formatMessage({ id: 'votingNew.countDown.end' });
    }

    if (currentPhase.isOver) {
      countDownText = formatMessage({ id: 'votingNew.countDown.over' });
    }
